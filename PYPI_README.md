...
|----------|--------|----------|
| **Python** (`abspc` package) | ✅ Available | `abspc/` |
...
| Type | Meaning |
|------|---------|
| Improvement (high) | Special-cause improvement (values trending higher) |
| Improvement (low) | Special-cause improvement (values trending lower) |
| Common cause | No special-cause variation detected |
| Concern (high) | Special-cause concern (values trending higher) |
| Concern (low) | Special-cause concern (values trending lower) |
...
| Hit or miss | Target may or may not be met |
| Fail | Target will consistently not be met |
